DEVICE     = atmega328p
CLOCK      = 16000000
OBJECTS    = lib/mcp2515/src/spi.o lib/mcp2515/src/mcp2515.o lib/uart.o lib/tick.o lib/output.o lib/pwm.o lib/button.o
...
clean:
	rm -f $(addsuffix /*.hex, $(USER_FOLDERS)) $(addsuffix /*.elf, $(USER_FOLDERS)) $(addsuffix *.o, $(dir $(OBJECTS)) $(addsuffix /, $(USER_FOLDERS))) $(addsuffix *.expand, $(dir $(OBJECTS)) $(addsuffix /, $(USER_FOLDERS))) $(addsuffix /*.ps, $(USER_FOLDERS)) lib/handler.h
...
%.elf: FORCE
	...
	$(COMPILE) -std=gnu99 -Wl,-gc-sections -o $@ $(OBJECTS) $(basename $@).o
